...
const TeacherAttendanceHeader = () => {
  return (
    <div className="flex justify-between items-start mb-8">
      <div>
        <h1 className="text-[32px] font-semibold text-[#1A1A1A] mb-2">Attendance</h1>
        <p className="text-[15px] text-gray-500">Record and manage daily studio session attendance for PMA Morning.</p>
      </div>
      <div className="flex items-center gap-4">
        <div className="border border-gray-200 rounded-lg px-4 py-2 flex items-center gap-2 text-[13px]">
          <span className="text-gray-500">Date:</span>
          <Calendar className="w-4 h-4 text-gray-600" />
          <span className="text-[#1A1A1A] font-medium">Monday, September 7, 2026</span>
        </div>
