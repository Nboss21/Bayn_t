...
const StudentAttendanceCard = ({ student }) => {
  const { attendance, attendanceDetails } = student;
  const { present, absent, excused } = attendanceDetails;
      ...
      {needsAttention && (
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <Link
            ...
            className="text-[13px] font-medium text-[#2F4F3A] border border-[#C8DBC0] hover:bg-[#F0F7EC] px-3 py-1.5 rounded-md transition-colors whitespace-nowrap"
          >
