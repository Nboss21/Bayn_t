    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-[#fffbeb] border border-[#fef08a] rounded-xl p-4 mb-6">
      <div className="flex items-center gap-3">
        ...
        <div className="text-sm">
          ...
          <span className="text-[#4b5563] ml-2">2 accounts are awaiting role assignment.</span>
        </div>
      </div>
      <button className="mt-4 sm:mt-0 px-4 py-2 bg-white border border-[#fef08a] text-[#b45309] text-sm font-medium rounded-lg hover:bg-[#fef3c7] transition-colors cursor-pointer">
        Review accounts
      </button>
    </div>
  );
