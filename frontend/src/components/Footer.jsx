  ...
  return (
    <footer className="bg-[#a87b52] text-white">
      ...
      <div className="max-w-7xl mx-auto w-[90%] py-20 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-16">
        ...
        {/* Academy Links */}
        <div>
          <h4 className="text-[11px] font-bold uppercase tracking-widest text-white mb-6">Academy</h4>
          <ul className="space-y-4 text-[14px] text-white/85">
            <li><a href="#" className="hover:text-white transition">About</a></li>
            <li><a href="#" className="hover:text-white transition">Programs</a></li>
            <li><Link to="/teachers" className="hover:text-white transition">Teachers</Link></li>
        ...
        {/* Connect / Social */}
        <div>
          <h4 className="text-[11px] font-bold uppercase tracking-widest text-white mb-6">Connect</h4>
          <ul className="space-y-4 text-[14px] text-white/85">
            <li>
              <a href="#" className="flex items-center space-x-3 hover:text-white transition">
                {/* Facebook */}
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 6.003 4.388 10.974 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.047 24 18.076 24 12.073z" /></svg>
                <span>Facebook</span>
              </a>
            </li>
            <li>
