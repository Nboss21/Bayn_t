...
const HorizontalProgramCard = ({
  ...
  return (
    <div className={`bg-[#f5f4ef] rounded-[2px] shadow-[0_2px_16px_rgba(0,0,0,0.03)] p-6 sm:p-8 lg:p-12 lg:pr-16 min-h-[380px] sm:min-h-[420px] lg:min-h-[440px] flex flex-row items-center justify-end relative ${className}`}>
      {/* Content aligned to right side with ample left empty space */}
      <div className="w-full sm:w-[280px] lg:w-[300px] flex flex-col">
        {/* Metadata */}
