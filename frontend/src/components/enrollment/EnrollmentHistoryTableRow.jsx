...
export default function EnrollmentHistoryTableRow({ record, onView }) {
  const statusStyles = {
    ...
    <tr className="border-b border-[#f3f4f6] hover:bg-[#fafbf7] transition-colors">
      ...
      <td className="px-6 py-4">
        <button
          ...
          className="px-4 py-1.5 border border-[#e5e7eb] rounded-lg text-[13px] font-medium text-[#374151] bg-white hover:bg-[#f9fafb] transition-colors"
        >
          View
        </button>
      </td>
