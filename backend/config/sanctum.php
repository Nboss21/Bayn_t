...
return [
    ...
    | and production domains such as 'localhost' or '127.0.0.1'.
    |
    */
    ...
    */
    ...
    | itself. If null, tokens do not expire.
    |
    */
    ...
    | the middleware Sanctum uses while processing requests. You may change the
    | middleware listed below as required.
    |
    */
